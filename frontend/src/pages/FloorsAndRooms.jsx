                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="text-center text-sm mb-4">
                          Total Rooms: {floorRooms.length} | Occupied:{' '}
                          {occupiedRooms}
                        </p>
                        <div className="flex flex-col items-center">
                          {floorRooms.map(room => {
                            const occupiedDesks = room.desks.filter(
                              desk => desk.usage > 0
                            ).length;
                            const totalDesks = room.desks.length;
                            const occupancyPercentage =
                              totalDesks > 0
                                ? (occupiedDesks / totalDesks) * 100
                                : 0;
                                ...
                                >
                                  <div className="flex justify-between items-center">
                                    <p className="font-medium">
                                      Room {room.name} ({room.capacity} desks)
                                    </p>
                                    ...
                                    {room.desks.map((desk, index) => (
                                      ...
                                      >
                                        ...
                                        <div className="relative w-full mt-2">
                                          ...
                                          />
                                          <span className="absolute top-0 left-1/2 transform -translate-x-1/2 text-xs font-semibold text-gray-700">
                                            {desk.usage}%
                                          </span>
                                        </div>
